...
const ProductViewer = () => {
    ...
    return (
        <section id='product-viewer'>
            ...
            <div className='controls'>
                ...
                <div className='flex-center gap-5 mt-5'>
                    ...
                    <div className='size-control'>
                        <div 
                            onClick={()=>setScale(0.06)} className={clsx(scale === 0.06 ? 'bg-white text-black' : 'bg-transparent')} 
                        >
                            <p>14"</p>
                        </div>
                        <div 
                            onClick={()=>setScale(0.08)} className={clsx(scale === 0.08 ? 'bg-white text-black' : 'bg-transparent')} 
                        >
                            <p>16"</p>
                        </div>
                    </div>
            ...
            <Canvas id="canvas" camera={{position: [0, 2, 5], fov: 55, near: 0.1, far: 100}}>
                <StudioLight/>
